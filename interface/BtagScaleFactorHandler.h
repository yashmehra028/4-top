...
// Originally from https://raw.githubusercontent.com/usarica/CMS3NtupleTools/combined/AnalysisTree/interface/BtagScaleFactorHandler.h (access: 23/01/01)

#include <unordered_map>
#include "IvyFramework/IvyDataTools/interface/ExtendedHistogram_2D.h"
...
public:
  ...
  void getSFAndEff(SystematicsHelpers::SystematicVariationTypes const& syst, float const& pt, float const& eta, short const& pujetidcat, BTagEntry::JetFlavor const& flav, unsigned short const& btagcat, float& val, float* effval) const;
