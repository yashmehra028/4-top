...
#define MUON_EXTRA_UNUSED_VARIABLES_COMMON \
...
#define MUON_EXTRA_UNUSED_VARIABLES_RUN2

#define MUON_EXTRA_UNUSED_VARIABLES_RUN3
...
#define MUON_EXTRA_USED_VARIABLES_COMMON \
...
#define MUON_EXTRA_USED_VARIABLES_RUN2

#define MUON_EXTRA_USED_VARIABLES_RUN3 \
